...
# Supported products are ['appliance', 'camera', 'cellularGateway', 'switch', 'sensor', 'wireless', 'switchCatalyst']
products = ['appliance', 'camera', 'cellularGateway', 'switch', 'sensor', 'wireless', 'switchCatalyst']

# Delay Config
delay_tag = 'fw-delay'
delay_use_days = True # If delay_use_specific_date is True, this cannot be True, and delay_days must have a value
delay_use_specific_date = False # If delay_use_days is True, this cannot be True, and delay_specific_date must
# have a value
# These dates need to be further into the future than the currently scheduled upgrade
delay_days = 30 # cannot be greater than 30
